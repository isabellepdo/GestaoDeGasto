...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference("Fornecedor.count") do
      post fornecedors_url, params: { fornecedor: { cpf_cnpj: @fornecedor.cpf_cnpj, nome: @fornecedor.nome } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cpf_cnpj: @fornecedor.cpf_cnpj, nome: @fornecedor.nome } }
